...
public class TelaContador extends javax.swing.JFrame {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(lblInicio, javax.swing.GroupLayout.PREFERRED_SIZE, 15, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
    ...
    private void sliInicioStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_sliInicioStateChanged
        ...
        int i = sliInicio.getValue();// Recebe o valor que está no slider.
        lblInicio.setText(Integer.toString(i));// Mostra o valor do slider. 
    ...
    private void btnContActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnContActionPerformed
        // TODO add your handling code here:
        // Programar o botão Contar
        int i = sliInicio.getValue();
        int f = sliFim.getValue();
        int p = sliPasso.getValue();
        
        // Criar a classe da lista
        DefaultListModel Lista = new DefaultListModel();
        
        // Comando for
        for(int c =1; c<=f; c+=p){
            Lista.addElement(c);// Adiciona o valor na lista
            
        }
        lstCont.setModel(Lista);// A lista recebe os valores.
